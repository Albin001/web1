...
##
###Main Project
###Write a program to bulid a bank account software using class
###The user should be able to open account with name, address, adhaar number and zero balance.
###assign 3 digit account no. from 100.
###After account is opened user can - deposit and withdraw money. check balance. money tranfer to another account number.
##
